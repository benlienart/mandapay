...
<html lang="en">
  <head>
    ...
    <title>Mandapay - Solutions pour le ecommerce</title>
    ...
    <div class="wrapper">
      ...
      <div class="topic">
        <div class="container">
          <div class="row">
            <div class="col-sm-4">
              <h3>Solutions de paiement ecommerce</h3>
            </div>
            <div class="col-sm-8">
              <ol class="breadcrumb pull-right hidden-xs">
                <li><a href="index.html">Accueil</a></li>
                <li class="active">Solutions de paiement ecommerce</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-7">
            <h3 class="headline"><span>Company Introduction</span></h3>
            <p>
          ...
          <div class="col-sm-5">
            <h3 class="headline"><span>Video Guide</span></h3>
        ...
        <div class="row">
          <div class="col-sm-12">
            <h3 class="headline"><span>Main Services Provided By Your Company</span></h3>
            <p>
